...
# │ one_valid    ┆ dir_many_json ┆ non_existed_dir │   python rectangle_module.py -l a -w 2 -i ./data -o result_test/subdir
...
# │ one_valid    ┆ dir_one_json  ┆ non_existed_dir │   python rectangle_module.py -l 2 -w a -i ./data_single/ -o ./result_test
...
# │ one_valid    ┆ dir_no_json   ┆ non_existed_dir │   python rectangle_module.py -l a -w 2 -i ../ -o ./result_test
...
# │ one_valid    ┆ json_file     ┆ non_existed_dir │   python rectangle_module.py -l 2 -w a -i ./data_single/rectangle_single.json -o ./result_test
...
# │ one_valid    ┆ other_file    ┆ non_existed_dir │   python rectangle_module.py -l a -w 2 -i ./rectangle_logs.txt -o ./result_test
...
# │ one_valid    ┆ not_existed   ┆ non_existed_dir │   python rectangle_module.py -l 2 -w a -i ./abcxyz -o ./result_test
